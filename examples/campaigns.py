...
print('Get all contacts from main campaign: \n {}'.format(
    getresponse.get_campaign_contacts(campaign_id, query=['email=com', 'name=а'], fields='name,email,campaigns')))
...
print('Get campaign list size from main campaign: \n {}'.format(
    getresponse.get_campaigns_statistics_list_size(['groupBy=month'], campaign_id,
